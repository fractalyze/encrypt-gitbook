...
* We strongly recommend choosing topics based on academic papers. Product-centric studies can quickly become outdated, so please focus on theoretical backgrounds or specific code implementations within a product.\
  **Example:** Instead of a broad overview of “SP1,” focus on the theoretical background or a particular piece of code used in SP1.
* For newer fields (e.g., MPC, FHE), it is acceptable to start with overview documents or tutorials (e.g., [_Lattice Based Cryptography for Beginners_](https://eprint.iacr.org/2015/938.pdf)).
* Here is the link to our [Paper Reading Research List](https://docs.google.com/spreadsheets/d/1CAH8tEEUmh_kD7LKyF27hzMEeMZQx_Khnk6RjO1icEU/edit?gid=0#gid=0) for reference on past and future topics the maintainer team has thought up.
